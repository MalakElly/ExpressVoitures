...
namespace GestionVoituresExpress.Migrations
{
    ...
    [Migration("20250422134230_DataAnnotationsUserBinding")]
    partial class DataAnnotationsUserBinding
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestionVoituresExpress.Models.Repairing", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("RepairingId"));
            ...
            modelBuilder.Entity("GestionVoituresExpress.Models.RepairingAndType", b =>
                {
                    b.Property<int>("RepairingId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("RepairingId", "RepairingTypeId");

                    b.HasIndex("RepairingTypeId");

                    b.ToTable("RepairingAndType");
                });

            modelBuilder.Entity("GestionVoituresExpress.Models.RepairingType", b =>
                {
                    b.Property<int>("RepairingTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("RepairingName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("RepairingTypeId");

                    b.ToTable("RepairingType");
                });
            ...
            modelBuilder.Entity("GestionVoituresExpress.Models.User", b =>
                {
            ...
            modelBuilder.Entity("GestionVoituresExpress.Models.RepairingAndType", b =>
                {
                    b.HasOne("GestionVoituresExpress.Models.Repairing", "Repairing")
                        .WithMany("RepairingAndTypes")
                        .HasForeignKey("RepairingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GestionVoituresExpress.Models.RepairingType", "RepairingType")
                        .WithMany("RepairingAndTypes")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GestionVoituresExpress.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GestionVoituresExpress.Models.Repairing", b =>
                {
                    b.Navigation("RepairingAndTypes");
                });
