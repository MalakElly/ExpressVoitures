            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RepairingId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RepairingDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RepairingPrice = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CarID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Repairing", x => x.RepairingId);
                    table.ForeignKey(
