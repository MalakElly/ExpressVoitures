...
namespace GestionVoituresExpress.Migrations
{
    ...
    [Migration("20250314150844_UpdateCarModel2")]
            ...
            modelBuilder.Entity("GestionVoituresExpress.Models.Car", b =>
                {
                    ...
                    b.Property<string>("FixingDetails")
                        .HasColumnType("nvarchar(max)");

                    b.Property<double>("FixingPrice")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("GestionVoituresExpress.Models.Transaction", b =>
                {
                    b.HasOne("GestionVoituresExpress.Models.Car", "Car")
                        .WithOne("Transaction")
                        .HasForeignKey("GestionVoituresExpress.Models.Transaction", "CarID")
